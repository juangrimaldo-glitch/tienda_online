...
<div class="container d-flex justify-content-center align-items-center py-5 text-gold" style="min-height:85vh;">
    <div class="card bg-dark p-4 rounded shadow-lg text-gold"
         style="max-width: 420px; width:100%; border:1px solid #4aeb4440;">
        
        <h2 class="text-center mb-3 text-gold">Crear Cuenta</h2>
        ...
        <form method="post" action="index.php?url=usuarios/registro<?= $keep ?>">
            <div class="mb-3">
                <label class="form-label text-gold">Usuario:</label>
                <input type="text" name="username" class="form-control bg-dark text-light border-warning" required>
            </div>
            ...
            <button type="submit" class="btn btn-warning fw-bold w-100">Crear Cuenta</button>
        </form>

        <p class="text-center mt-3">
            ¿Ya tienes cuenta?<br>
            <a href="index.php?url=usuarios/login<?= $keep ?>" class="fw-bold text-gold">Ingresar</a>
        </p>
    </div>
</div>
